...
def main():
    ...
    # CHANGE BUTTON SETUP TO INCLUDE MORE COLORS. ADDED BUTTON AND COLOR GREEN
    choicePairs = list()
    ...
    window = makeColoredRect(Point(150, 180), 50,100, 'white', win)
    roof.setFill('black')
    roof.draw(win)

    # ADDED A WINDOW
    shapePairs = [(house, 'house'), (door, 'door'), (roof, 'roof'), (window, 'window)')]
